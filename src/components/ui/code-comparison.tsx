...
export function CodeComparison({
    ...
    if (highlighted) {
      return (
        <div
          ...
          className={cn(
            "bg-white h-full w-full overflow-auto font-mono text-xs dark:bg-neutral-950",
      ...
      return (
        <pre className="bg-white text-neutral-950 h-full overflow-auto p-4 font-mono text-xs break-all dark:bg-neutral-950 dark:text-neutral-50">
          {code}
        </pre>
      );
    }
  ...
  return (
    <div className="mx-auto w-full max-w-5xl">
      <div className="group border-neutral-200 relative w-full overflow-hidden rounded-md border dark:border-neutral-800">
        <div className="relative grid md:grid-cols-2">
          <div
            className={cn(
              "leftside group/left border-neutral-900/20 md:border-r dark:border-neutral-50/20",
              hasLeftFocus &&
          ...
          >
            <div className="border-neutral-900/20 bg-neutral-100 text-neutral-950 flex items-center border-b p-2 text-sm dark:border-neutral-50/20 dark:bg-neutral-800 dark:text-neutral-50">
          ...
          <div
            className={cn(
              "rightside group/right border-neutral-900/20 border-t md:border-t-0 dark:border-neutral-50/20",
              hasRightFocus &&
                "[&>div>pre>code>:not(.focused)]:!opacity-50 [&>div>pre>code>:not(.focused)]:!blur-[0.095rem]",
              "[&>div>pre>code>:not(.focused)]:transition-all [&>div>pre>code>:not(.focused)]:duration-300"
            )}
        ...
        <div className="border-neutral-900/20 bg-neutral-100 text-neutral-950 absolute top-1/2 left-1/2 hidden h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-md border border-neutral-200 text-xs md:flex dark:border-neutral-50/20 dark:bg-neutral-800 dark:text-neutral-50 dark:border-neutral-800">
          VS
        </div>
      </div>
    </div>
